...
/**
 * An interface implemented by classes which can convert content record data to some output format.
 *
...
public interface RecordConverter {
    ...
    void writeContent(Record content, AuthorityResponse response);
